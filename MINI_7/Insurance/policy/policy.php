  ...
  background: #88ABFF; 
        ...
        <form name = "form1" action='modified.php' method = 'POST' enctype = "multipart/form-data" >    
		    ...
		    <div class = "form_group">    
                ...
                <div class = "form_group">    
                    <label>DOC:</label>    <input type = "date" name = "DOC" value = "" required /> 
                </div>  
		    <div class = "form_group">    
                    <label>Product:</label>     <input type = "text" name = "Product" value = "" required />  
                </div>
		    <div class = "form_group">    
                    <label>Sum Assured: </label>     <input type = "text" name = "Sum_assured" value = ""  required />
                </div>
		     <div class = "form_group">    
		     ...
		     <div class = "form_group">    
                    <label>Insurance Period: </label> <input type = "text" name = "Ins_period" value = ""  required />    
                 </div>
		     <div class = "form_group">    
